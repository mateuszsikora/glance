...
7. An authenticated remote form save updates `AppConfig`, asks `KioskService` to rebuild MQTT and schedule state, and broadcasts the same dashboard reload used by local settings.
